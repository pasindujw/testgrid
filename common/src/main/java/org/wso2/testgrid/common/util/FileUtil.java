...
public class FileUtil {
    ...
    /**
     * This method returns the list of files in a given directory.
     * @param directory the directory in which the files should be look-up
     * @return list of files
     * @throws TestGridException thrown when an error occured while accessing files on directory.
     */
    public static List<String> getFilesOnDirectory(String directory) throws TestGridException {
        List<String> files = new ArrayList<>();
        try {
            DirectoryStream<Path> stream = Files.newDirectoryStream(Paths.get(directory), "*.jmx");
