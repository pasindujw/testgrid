...
public class ScenarioExecutor {
    ...
    private void createRunScenarioScript(String directory) throws ScenarioExecutorException {
        try {
            List<String> files = FileUtil.getFilesOnDirectory(
                    directory + TestGridConstants.FILE_SEPARATOR + JMETER_FOLDER);
    ...
    /**
     * This method prepare the content of the run-scenario script which will include complete shell commands including
     * script file names.
